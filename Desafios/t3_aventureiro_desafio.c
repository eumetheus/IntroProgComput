//-------------------------------------------------------------------
// Desafio Aventureiro do tema 3 :Criando as Cartas do Super Trunfo
//-------------------------------------------------------------------
...
int main() {
    ...
    printf("Digite a categoria para comparar as Cartas 1 e 2: \n");
    printf(" \n");
    ...
    switch (comp) {
        ...
        case 1:
            ...
            printf("Categoria de Comparação: População\n \n");
        ...
        case 2: 
            ...
            printf("Categoria de Comparação: Área\n \n");
        ...
        case 3: 
            ...
            printf("Categoria de Comparação: PIB\n \n");
        ...
        case 4: 
            ...
            printf("Categoria de Comparação: Pontos Turísticos\n \n");
        ...
        case 5: 
            ...
            printf("Categoria de Comparação: Densidade Demográfica\n \n");
        ...
        case 6: 
            ...
            printf("Vocês escolheu sair do jogo. Tchau!\n");

            break;

        default:
        
            printf("Opção Inválida. Reinicie o jogo e tente novamente.\n");
