...
int main() {
    ...
    switch (opcao) {
        ...
        case 1:
            ...
            srand(time(0)); // Gerando a semente do número aleatório utilizando a datahora atual em segundos
            numeroSecreto = rand() % 10 + 1; // Número secreto é o número aleatório (definido pela semente)  de 1 a 10
